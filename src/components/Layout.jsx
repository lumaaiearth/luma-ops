...
import { LayoutDashboard, CalendarDays, Radio, Users, Settings, LogOut, Clock, Map, Database, FolderOpen, MoreHorizontal, BarChart2, Flower2, ListTodo, UserCircle, Search, PanelLeftOpen, PanelLeftClose, Radar, Sprout } from 'lucide-react'
...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      // Pflegeplanung: Pläne, Kapazität, Plan/Ist, Angebote (docs/PFLEGEPLANUNG_KONZEPT.md)
      { to: '/pflege',    icon: Sprout,          label: 'Pflege' },
