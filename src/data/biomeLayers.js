...
export const OPEN_LAYERS = [
  ...
  { id: 'sonnen_heatmap', label: 'Sonnen-Heatmap (21.6.)', color: '#fbbf24', cat: 'hitze', region: 'Projekte',
    custom: 'lod2-heatmap',
    desc: 'Eigene Simulation: direkte Sommer-Sonnenstunden im 4-m-Raster aus LoD2-Dachmodell + Baumkataster (dunkelblau = dauerbeschattet, gelb = vollsonnig). Verfügbar in den Projektgebieten.' },
