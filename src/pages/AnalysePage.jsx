...
const ANALYSES = [
  ...
  {
    id: 'schwammstadt-bodeninfiltration-berlin',
    title: 'Die Schwammstadt — Wenn Böden wieder atmen lernen',
    subtitle: 'Berlins Kampf gegen Extremregen und urbane Überflutung',
    region: 'Berlin & Deutschland',
    date: 'Juni 2026',
    tags: ['Schwammstadt', 'Klimaanpassung', 'Bioporen', 'Berlin'],
    icon: Droplets,
    color: '#0369a1',
    colorLight: '#0284c7',
    colorBgDark: 'rgba(3,105,161,0.1)',
    colorBgLight: 'rgba(2,132,199,0.08)',
    colorBorderDark: 'rgba(3,105,161,0.3)',
    colorBorderLight: 'rgba(2,132,199,0.25)',
    kpis: [
      { label: 'Berlin versiegelt', value: '33,9 %' },
      { label: 'Infiltrationsverbesserung', value: 'bis 400 %' },
      { label: 'Schaden 2024', value: '2,6 Mrd €' },
    ],
    description: 'Berlins Böden sind zu fast 34 Prozent versiegelt. Die Schwammstadt-Philosophie und Bodenverbesserung durch Bioporen, Mulchen und organische Substanz. Mit aktuellen Copernicus-Klimadaten 2025.',
    route: '/analyse/artikel/schwammstadt-bodeninfiltration-berlin',
  },
  {
    id: 'urbane-biodiversitaet-heimische-pflanzen',
    title: 'Heimische Pflanzen als Lebensader der Stadt',
    subtitle: 'Warum urbane Artenvielfalt nur mit standortgerechter Bepflanzung funktioniert',
    region: 'Berlin & Deutschland',
    date: 'Juni 2026',
    tags: ['Biodiversität', 'Heimische Pflanzen', 'Miyawaki', 'Insektenschutz'],
    icon: Leaf,
    color: '#16a34a',
    colorLight: '#15803d',
    colorBgDark: 'rgba(22,163,74,0.1)',
    ...
    colorBorderLight: 'rgba(21,128,61,0.25)',
    kpis: [
      { label: 'Insektenbiomasse-Rückgang', value: '−76 %' },
      { label: 'Exklusiv auf heimischen Bäumen', value: '32 %' },
      { label: 'Luma Pflanzpalette', value: '73 Arten' },
    ],
    description: 'Während Europa 76 % seiner Fluginsekten verloren hat, reagiert das Stadtgrün noch mit ornamentalen Exoten. Heimische Pflanzen und die Miyawaki-Methode als evidenzbasierte Antwort.',
    route: '/analyse/artikel/urbane-biodiversitaet-heimische-pflanzen',
  },
  {
    id: 'eichenprozessionsspinner-biologische-bekaempfung',
    title: 'EPS ohne Gift',
    subtitle: 'Biologische Bekämpfung des Eichenprozessionsspinners mit Bacillus thuringiensis',
    region: 'Berlin & Deutschland',
    date: 'Juni 2026',
    tags: ['EPS', 'Bacillus thuringiensis', 'Biologische Bekämpfung', 'Stadtbäume'],
    icon: Bug,
    color: '#b45309',
    colorLight: '#d97706',
    colorBgDark: 'rgba(180,83,9,0.1)',
    colorBgLight: 'rgba(217,119,6,0.08)',
    colorBorderDark: 'rgba(180,83,9,0.3)',
    colorBorderLight: 'rgba(217,119,6,0.25)',
    kpis: [
      { label: 'Btk Wirkungsgrad', value: '70–90 %' },
      { label: 'EPS Brennhaare/Nest', value: '700.000' },
      { label: 'Eichen gespritzt Bayern 2020', value: '>20.000' },
    ],
    description: 'Der EPS breitet sich klimabedingt weiter aus. Bacillus thuringiensis bietet 70–90 % Wirkungsgrad ohne Ökosystemschaden. Berlins Stufenmodell und Lumas Bio-First-Ansatz als Marktchance.',
    route: '/analyse/artikel/eichenprozessionsspinner-biologische-bekaempfung',
  },
]
